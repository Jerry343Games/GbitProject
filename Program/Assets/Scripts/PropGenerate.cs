...
public class PropGenerate : MonoBehaviour
{
    public static PropGenerate Instance { get; private set; } = new PropGenerate();
    ...
    public float duaration = 20f;
    private float curDuaration = 20f;
    ...
    IEnumerator DelayMyselfInvis(GameObject coin)
    {
        ...
        if (coin != null && coin.transform.parent == null)
        {
            Destroy(coin);
        }
    }
